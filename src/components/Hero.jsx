      ...
      <div className="hero-content text-neutral-content text-center">
        <div className="max-w-md">
          ...
          <button className="relative cursor-pointer hover:translate-y-0.5">
            ...
            <span className="fold-bold relative inline-block h-full w-full rounded border-2 border-secondary bg-primary px-3 py-1 text-base font-bold text-white transition duration-100 hover:bg-yellow-400 hover:text-secondary">
              Start Your Journey
            </span>
          </button>
        </div>
